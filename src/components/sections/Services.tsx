...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      icon: Cpu,
      nameKey: "service.ict",
      descKey: "service.ict.desc",
      color: "bg-purple-500/10 text-purple-600",
    },
    {
      icon: Cog,
      nameKey: "service.mechanical",
      descKey: "service.mechanical.desc",
      color: "bg-slate-500/10 text-slate-600",
    },
    {
      icon: Tv,
      nameKey: "service.electronics",
      descKey: "service.electronics.desc",
      color: "bg-pink-500/10 text-pink-600",
    },
    {
      icon: Sun,
      nameKey: "service.solar",
      descKey: "service.solar.desc",
      color: "bg-yellow-500/10 text-yellow-600",
    },
    {
      icon: Wind,
      nameKey: "service.hvac",
      descKey: "service.hvac.desc",
      color: "bg-cyan-500/10 text-cyan-600",
    },
    {
      icon: Building,
      nameKey: "service.construction",
